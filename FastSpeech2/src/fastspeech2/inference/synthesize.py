...
from fastspeech2.data.dataset import TextDataset
from fastspeech2.text import text_to_sequence, clean_vietnamese_text
import fastspeech2.text.vietnamese_phonemes as viphonemes
...
if __name__ == "__main__":
    ...
    if args.mode == "single":
        ...
        if preprocess_config["preprocessing"]["text"]["language"] == "en":
            ...
            raise ValueError("Only English (en) and Vietnamese (vi) are supported")
